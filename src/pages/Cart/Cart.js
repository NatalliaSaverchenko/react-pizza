...
const dispatch = useDispatch()
  ...
  const onPlusCartItem = (id, index) =>{
    dispatch(plusCartItem({
      id, 
      index})
      )
  }
  const onMinusCartItem = (id, index) =>{
      ...
      {totalCount ?  <div className="cart">
        ...
        {idPizzas.map((id) =>
              items[id].items.map((props, index) => (
                <CartItem
                  ...
                  addCartItem={onPlusCartItem}
                  subCartItem={onMinusCartItem}
        ...
        <div className="cart__bottom">
          ...
          <div className="cart__bottom-buttons">
            ...
            <div onClick = {doPay} className="button pay-btn">
